...
import { account, mantle, walletClient, publicClient } from "./chain.js";
...
// Get the DeleGator environment for the active EVM chain
const environment = getDeleGatorEnvironment(mantle.id);
 ...
 *
 * This makes the offchain-signed ERC-7715 delegation visible on an explorer
